# Relatório de Alterações — Projeto Vaga Lúmen

> Atualizado em: 25 de junho de 2026  
> Próxima ação: análise pelo grupo ECOSALA

---

## Novas fichas incorporadas ao repositório científico
...
| Documento | Mudança |
|---|---|
| **Proposta Final** | Links de referência apontam para GH Pages público. TRL ajustado com base em evidências. Seção náutica com estudo Arte Naval no Acre. |
| **Regulamento FINEP** | Convertido de PDF para .md. 14 páginas, 36.891 caracteres. |
| **Plano de Correção** | 13 itens mapeados vs. regulamento. 4 críticos, 6 médios, 3 baixos. |

## Skill google-flow atualizada

Adicionado à seção de lições aprendidas: preferências do usuário, armadilhas identificadas, e tabela completa dos 8 repositórios do ecossistema.

## Arquivos na raiz do GitHub

| Arquivo | Conteúdo |
|---|---|
| `~/GitHub/como-dirigir-agentes-IA.md` | Guia de interação com agentes de IA |
| `~/GitHub/avaliacao-iteracao-fabio-hermes.md` | Avaliação da iteração no projeto |

## Links públicos consolidados

| Documento | URL |
|---|---|
| Proposta Final (submissão) | https://takwaratec.github.io/plataforma-juventude-solidaria-2026/editais/fundo-vaga-lumen-2026/proposta-final-vaga-lumen/ |
| Regulamento FINEP | https://takwaratec.github.io/plataforma-juventude-solidaria-2026/editais/fundo-vaga-lumen-2026/regulamento-finep-mais-inovacao/ |
